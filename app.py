...
from utils import save_chat_history_json, load_chat_history_json, get_time_stamp
...
def save_chat_history():
    if st.session_state.history != []:
        if st.session_state.session_key == "new_session":
            st.session_state.new_session_key = get_time_stamp() + ".json"
...
def main():
    ...
    upload_audio = st.sidebar.file_uploader("upload an audio file",type=["wav","mp3","ogg"])
    ...
    if upload_audio:
        transcribed_audio = transcribe_audio(voice_recording.getvalue())
